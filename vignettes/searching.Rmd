...
Best Practical's [Query Builder documentation](https://docs.bestpractical.com/rt/4.4.0/query_builder.html) and [Ticket SQL wiki page](https://rt-wiki.bestpractical.com/wiki/TicketSQL) highlight some of the key aspects of query-building and are useful to reference while learning.
...
In this example, we're using a local installation of RT but for your use case, you'll want to use a different `RT_BASE_URL` value.
See `?rt` for more information on setup.
