...
The `rt_search` function makes it easy to search through your tickets. These are the fields that it will return by default, and that you can use to search through.
...
```{r eval = FALSE}
result <- rt_search("Content LIKE 'Can you please advise'")
